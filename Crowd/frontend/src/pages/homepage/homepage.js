import { useState, useEffect } from "react";
  ...
  export default function Homepage() {
    ...
    const login = async (event) => {
      ...
      try {
        const response = await axios.post('https://crowd-app-qfen.onrender.com/user/login', {
          email:email,
          password:password
...
try {
  const response = await axios.get("https://crowd-app-qfen.onrender.com/user/logout", { withCredentials: true });
    ...
    const register = async (event) => {
      ...
      try {
      const response = await axios.post("https://crowd-app-qfen.onrender.com/user/company/register",{
      ...
      try {
        const response = await axios.post("https://crowd-app-qfen.onrender.com/user/personal/register",{
        registerData:registerData});
